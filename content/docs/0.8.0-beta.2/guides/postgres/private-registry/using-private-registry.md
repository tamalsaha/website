...
Follow the steps to [install KubeDB operator](/docs/0.8.0-beta.2/setup/install) properly in cluster so that to points to the DOCKER_REGISTRY you wish to pull images from.
...
If you would like to uninstall KubeDB operator, please follow the steps [here](/docs/0.8.0-beta.2/setup/uninstall).
