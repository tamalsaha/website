...
To learn how to monitor Postgres databases, please visit [here](/docs/0.8.0-beta.2/concepts/monitoring).
...
- Learn how to use KubeDB to run a PostgreSQL database [here](/docs/0.8.0-beta.2/guides/postgres/quickstart/quickstart).
