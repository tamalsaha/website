...
```console
$ kubedb create -f https://raw.githubusercontent.com/kubedb/cli/0.8.0-rc.0/docs/examples/memcached/monitoring/coreos-operator/demo-1.yaml
...
![prometheus-coreos](/docs/0.8.0-rc.0/images/memcached/memcached-coreos.png)
