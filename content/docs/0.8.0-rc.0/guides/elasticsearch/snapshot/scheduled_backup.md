...
---
> Don't know how backup works?  Check [tutorial](/docs/0.8.0-rc.0/guides/elasticsearch/snapshot/instant_backup) on Instant Backup.
...
To learn how to configure other storage destinations for Snapshots, please [visit here](/docs/0.8.0-rc.0/concepts/snapshot).
...
```console
$ kubedb create -f https://raw.githubusercontent.com/kubedb/cli/0.8.0-rc.0/docs/examples/elasticsearch/snapshot/scheduled-es.yaml
