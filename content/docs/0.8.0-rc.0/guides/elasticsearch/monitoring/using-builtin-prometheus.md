...
```console
$ kubedb create -f https://raw.githubusercontent.com/kubedb/cli/0.8.0-rc.0/docs/examples/elasticsearch/monitoring/builtin-prom-es.yaml
...
<p align="center">
  <kbd>
    <img alt="builtin-prom-elasticsearch"  src="/docs/0.8.0-rc.0/images/elasticsearch/builtin-prom-es.png">
  </kbd>
</p>
