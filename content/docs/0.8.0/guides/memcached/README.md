...
- [Quickstart Memcached](/docs/0.8.0/guides/memcached/quickstart/quickstart) with KubeDB Operator.
...
- Use [kubedb cli](/docs/0.8.0/guides/memcached/cli/cli) to manage databases like kubectl for Kubernetes.
