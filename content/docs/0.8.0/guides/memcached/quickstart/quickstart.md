...
<p align="center">
  <img alt="lifecycle"  src="/docs/0.8.0/images/memcached/memcached-lifecycle.png" width="550" height="640">
</p>
...
KubeDB operator watches for `Memcached` objects using Kubernetes api. When a `Memcached` object is created, KubeDB operator will create a new Deployment and a ClusterIP Service with the matching Memcached object name. No Memcached specific RBAC permission is required in [RBAC enabled clusters](/docs/0.8.0/setup/install#using-yaml).
...
- Use [private Docker registry](/docs/0.8.0/guides/memcached/private-registry/using-private-registry) to deploy Memcached with KubeDB.
