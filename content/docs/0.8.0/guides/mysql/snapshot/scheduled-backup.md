...
To learn how to configure other storage destinations for Snapshots, please visit [here](/docs/0.8.0/concepts/snapshot).  Now, create the `MySQL` object with scheduled snapshot.
...
```console
$ kubedb create -f https://raw.githubusercontent.com/kubedb/cli/0.8.0/docs/examples/mysql/snapshot/demo-4.yaml
...
![snapshot-console](/docs/0.8.0/images/mysql/mysql-scheduled.png)
