...
---
> Don't know how backup works?  Check [tutorial](/docs/0.8.0/guides/postgres/snapshot/instant_backup) on Instant Backup.
...
- Take an instant backup, if not available. Follow [this](/docs/0.8.0/guides/postgres/snapshot/instant_backup#instant-backup).
...
Now lets connect to our Postgres `recovered-postgres`  using pgAdmin we have installed in [quickstart](/docs/0.8.0/guides/postgres/quickstart/quickstart#before-you-begin) tutorial.
...
<p align="center">
  <kbd>
    <img alt="recovered-postgres"  src="/docs/0.8.0/images/postgres/recovered-postgres.gif">
  </kbd>
</p>
