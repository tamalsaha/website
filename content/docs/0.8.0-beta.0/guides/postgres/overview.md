...
KubeDB operator watches for `Postgres` objects using Kubernetes api. When a `Postgres` object is created, KubeDB operator will create a new StatefulSet and two ClusterIP Service with the matching name. KubeDB operator will also create a governing service for StatefulSet with the name `kubedb`, if one is not already present. If [RBAC is enabled](/docs/0.8.0-beta.0/guides/rbac), a ClusterRole, ServiceAccount and ClusterRoleBinding with the matching CRD object name will be created and used as the service account name for the corresponding StatefulSet.
...
```
![Using p1 from pgAdmin4](/docs/0.8.0-beta.0/images/postgres/p1-pgadmin.gif)
...
![snapshot-console](/docs/0.8.0-beta.0/images/postgres/archive.png)
...
![Using p1 from pgAdmin4](/docs/0.8.0-beta.0/images/postgres/standby.gif)
...
![snapshot-console](/docs/0.8.0-beta.0/images/postgres/p1-xyz-snapshot.png)
...
## Next Steps
- Learn about the details of Postgres object [here](/docs/0.8.0-beta.0/concepts/databases/postgres).
